...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      ...
      <main className='w-fullflex flex-col justify-center'>
       <Hero />
      <br />
...
<a href="#" class="inline-flex items-center px-4 py-2 mr-3 text-sm font-medium  bg-[#f08e80] border border-gray-300 rounded-lg text-white hover:text-[#505050]">
